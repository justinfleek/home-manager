...

{
  ...
  programs.ssh = {
    ...
    # Disable default config to prevent future warnings
    enableDefaultConfig = false;

    # Global settings via wildcard match block
    matchBlocks."*" = {
      hashKnownHosts = true;
      compression = true;
    ...
    # GPU workstations
    matchBlocks."fxy-bml-8x6000-0x01" = {
      hostname = "fxy-bml-8x6000-0x01";
      user = "justin";
      identityFile = "~/.ssh/id_ed25519";
    };

    matchBlocks."fxy-g4-rtx6kpro-large-0x01" = {
      hostname = "fxy-g4-rtx6kpro-large-0x01";
      user = "justin";
      identityFile = "~/.ssh/id_ed25519";
    };

    matchBlocks."fxy-g4-rtx6kpro-large-0x02" = {
      hostname = "fxy-g4-rtx6kpro-large-0x02";
      user = "justin";
      identityFile = "~/.ssh/id_ed25519";
    };

    matchBlocks."fxy-g4-rtx6kpro-large-0x03" = {
      hostname = "fxy-g4-rtx6kpro-large-0x03";
      user = "justin";
      identityFile = "~/.ssh/id_ed25519";
    };

    matchBlocks."fxy-g4-rtx6kpro-large-0x04" = {
      hostname = "fxy-g4-rtx6kpro-large-0x04";
      user = "justin";
      identityFile = "~/.ssh/id_ed25519";
    };

    # Metal servers
    matchBlocks."fxy-m4-metal-large-mia2-0x01" = {
      hostname = "fxy-m4-metal-large-mia2-0x01";
      user = "justin";
      identityFile = "~/.ssh/id_ed25519";
    };

    matchBlocks."fxy-m4-metal-large-lax2-0x01" = {
      hostname = "fxy-m4-metal-large-lax2-0x01";
      user = "justin";
      identityFile = "~/.ssh/id_ed25519";
    };

    matchBlocks."fxy-m4-metal-large-ash-0x01" = {
      hostname = "fxy-m4-metal-large-ash-0x01";
      user = "justin";
      identityFile = "~/.ssh/id_ed25519";
    };

    matchBlocks."fxy-f4-metal-medium-sgp-0x01" = {
      hostname = "fxy-f4-metal-medium-sgp-0x01";
      user = "justin";
      identityFile = "~/.ssh/id_ed25519";
    };

    matchBlocks."fxy-f4-metal-medium-lon2-0x01" = {
      hostname = "fxy-f4-metal-medium-lon2-0x01";
      user = "justin";
      identityFile = "~/.ssh/id_ed25519";
    };

    matchBlocks."fxy-f4-metal-medium-lax-0x01" = {
      hostname = "fxy-f4-metal-medium-lax-0x01";
      user = "justin";
      identityFile = "~/.ssh/id_ed25519";
    };

    matchBlocks."fxy-f4-metal-medium-ash-0x01" = {
      hostname = "fxy-f4-metal-medium-ash-0x01";
      user = "justin";
      identityFile = "~/.ssh/id_ed25519";
    };

    # Monsoon 5090 machines
    matchBlocks."fxy-monsoon-5090-0x01" = {
      hostname = "fxy-monsoon-5090-0x01";
      user = "justin";
      identityFile = "~/.ssh/id_ed25519";
    };

    matchBlocks."fxy-monsoon-5090-0x02" = {
      hostname = "fxy-monsoon-5090-0x02";
      user = "justin";
      identityFile = "~/.ssh/id_ed25519";
    };

    matchBlocks."fxy-monsoon-5090-0x03" = {
      hostname = "fxy-monsoon-5090-0x03";
      user = "justin";
      identityFile = "~/.ssh/id_ed25519";
    };

    # Jetson
    matchBlocks."fxy-jetson-thor-0x01" = {
      hostname = "fxy-jetson-thor-0x01";
      user = "justin";
      identityFile = "~/.ssh/id_ed25519";
    };

    # Special machines
    matchBlocks."ultraviolence" = {
      hostname = "ultraviolence";
      user = "justin";
      identityFile = "~/.ssh/id_ed25519";
    };

    matchBlocks."fxy-bizon-threadripper-0x01" = {
      hostname = "fxy-bizon-threadripper-0x01";
      user = "justin";
      identityFile = "~/.ssh/id_ed25519";
    };
  };
